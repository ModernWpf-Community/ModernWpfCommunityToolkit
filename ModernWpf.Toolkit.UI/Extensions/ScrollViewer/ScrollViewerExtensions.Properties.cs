...
#pragma warning disable CS0419 // Ambiguous reference in cref attribute
        ...
        /// <summary>
        /// Attached <see cref="DependencyProperty"/> for binding a <see cref="Thickness"/> for the vertical <see cref="Primitives.ScrollBar"/> of a <see cref="ScrollViewer"/>
        /// </summary>
        ...
        /// <summary>
        /// Gets the <see cref="Thickness"/> associated with the specified vertical <see cref="Primitives.ScrollBar"/> of a <see cref="ScrollViewer"/>
        /// </summary>
        ...
        /// <summary>
        /// Sets the <see cref="Thickness"/> associated with the specified vertical <see cref="Primitives.ScrollBar"/> of a <see cref="ScrollViewer"/>
        /// </summary>
        ...
        /// <summary>
        /// Gets the <see cref="Thickness"/> associated with the specified horizontal <see cref="Primitives.ScrollBar"/> of a <see cref="ScrollViewer"/>
        /// </summary>
        /// <param name="obj">The <see cref="FrameworkElement"/> to get the associated <see cref="Thickness"/> from</param>
        /// <returns>The <see cref="Thickness"/> associated with the <see cref="FrameworkElement"/></returns>
        ...
        /// <summary>
        /// Sets the <see cref="Thickness"/> associated with the specified horizontal <see cref="Primitives.ScrollBar"/> of a <see cref="ScrollViewer"/>
        /// </summary>
        /// <param name="obj">The <see cref="FrameworkElement"/> to associate the <see cref="Thickness"/> with</param>
        /// <param name="value">The <see cref="Thickness"/> for binding to the <see cref="FrameworkElement"/></param>
