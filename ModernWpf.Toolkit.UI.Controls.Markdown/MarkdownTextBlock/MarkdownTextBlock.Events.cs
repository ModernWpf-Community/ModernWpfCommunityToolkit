...
namespace ModernWpf.Toolkit.UI.Controls
{
    ...
    public partial class MarkdownTextBlock
    {
        ...
        /// </summary>
        private void NewImagelink_Click(object sender, RoutedEventArgs e)
        {
            string hyperLink = (string)(sender as HyperlinkButton).GetValue(HyperlinkUrlProperty);
            bool isHyperLink = (bool)(sender as HyperlinkButton).GetValue(IsHyperlinkProperty);
        ...
        /// <summary>
        /// Fired when an emoji from the markdown document needs to be resolved.
        /// The default implementation is to output the EmojiInline as Plain Text.
        /// <para/>You must set <see cref="EmojiInlineResolvingEventArgs.Handled"/> to true in order to process your changes.
        /// </summary>
        public event EventHandler<EmojiInlineResolvingEventArgs> EmojiInlineResolving;
